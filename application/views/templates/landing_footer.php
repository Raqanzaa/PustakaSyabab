<footer>
    ...
    <div class="container">
      ...
      <ul class="footer-nav-list">
        ...
        <li class="footer-nav-item flex">
          ...
          <a href="tel:+6283849826116" class="footer-nav-link">083849826116</a>
        </li>
        ...
        <li class="footer-nav-item flex">
          ...
          <a href="mailto:example@gmail.com" class="footer-nav-link">pustakasyabab@gmail.com</a>
        </li>
  ...
  <div class="footer-bottom">
    ...
    <div class="container">
      ...
      <p class="copyright">
        Copyright &copy; <a href="#" style="color: aliceblue;">Pustaka Syabab</a> all rights reserved.
      </p>
